...
public class GildedLuckWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(GildedLuckWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/GildedLuckWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/GildedLuckWLAIW/InitOutcome.xml").getDocumentElement();
